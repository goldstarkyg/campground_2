...
@section('vendor-style')
        ...
        <link rel="stylesheet" href="{{URL::to('/')}}/vendors/css/pickers/pickadate/pickadate.css">
@endsection

@section('page-style')
        {{-- Page Css files --}}
        <link rel="stylesheet" href="{{URL::to('/')}}/css/plugins/forms/validation/form-validation.css">
        <link rel="stylesheet" href="{{URL::to('/')}}/css/pages/app-user.css">
...
@section('vendor-script')
  ...
  <script src="{{URL::to('/')}}/vendors/js/pickers/pickadate/picker.js"></script>
  <script src="{{URL::to('/')}}/vendors/js/pickers/pickadate/picker.date.js"></script>
@endsection

@section('page-script')
  {{-- Page js files --}}
  <script src="{{URL::to('/')}}/js/scripts/pages/app-user.js"></script>
  <script src="{{URL::to('/')}}/js/scripts/navs/navs.js"></script>
@endsection
